...
// fixture: box_y_through_hole
// fixture_type: box
// description: Box with one through-hole along the y axis. Covers y-axis hole case missing from existing suite.
$fn = 96;
...
difference() {
  ...
  through_hole_y([0.000000, 0.000000, 0.000000], 4.000000, 12.200000);  // hole_0
}
