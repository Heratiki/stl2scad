...
// fixture: box_z_through_hole_rotated_z25
// fixture_type: box
// description: Non-axis-aligned rotated box to baseline that rotated non-plate geometry is not mistakenly detected as box_like_solid.
