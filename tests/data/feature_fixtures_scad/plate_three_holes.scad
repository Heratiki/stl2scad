...
// fixture: plate_three_holes
// fixture_type: plate
// description: Three irregularly spaced holes (no pattern) to test hole counting without forcing a linear pattern.
$fn = 96;
...
difference() {
  ...
  through_hole([-10.000000, 0.000000, -0.100000], 3.000000, 2.200000);  // hole_0
  through_hole([0.000000, 2.000000, -0.100000], 4.000000, 2.200000);  // hole_1
  through_hole([9.000000, -1.000000, -0.100000], 2.500000, 2.200000);  // hole_2
}
