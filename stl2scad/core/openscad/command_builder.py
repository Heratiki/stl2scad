...
class OpenSCADCommandBuilder:
    ...
    def add_arg(
        self, arg: str, value: Optional[Union[str, Path]] = None
    ) -> "OpenSCADCommandBuilder":
        """
...
class OpenSCADCommandValidator:
    ...
    def validate_output_format(
        output_file: Union[str, Path], export_format: Optional[str] = None
    ) -> None:
        """
        ...
        if export_format:
            ...
            valid_extensions = list(
                {
                    ext
                    for fmt in OpenSCADCommandValidator.EXPORT_FORMATS.values()
