...
// fixture: plate_4x4_grid
// fixture_type: plate
// description: Dense 4x4 hole grid to exercise nested-loop emission and large hole counts.
$fn = 96;

plate_size = [36.000000, 36.000000, 2.000000];
plate_origin = [-18.000000, -18.000000, 0.000000];
...
difference() {
  ...
  for (row = [0 : 3]) {
    for (col = [0 : 3]) {
      through_hole([-12.000000, -12.000000, -0.100000] + row * [0.000000, 8.000000, 0.000000] + col * [8.000000, 0.000000, 0.000000], 2.000000, 2.200000);  // grid_pattern_0
    }
  }
}
