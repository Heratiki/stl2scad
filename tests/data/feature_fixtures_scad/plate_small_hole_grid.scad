...
// fixture: plate_small_hole_grid
// fixture_type: plate
// description: Small-diameter hole grid to exercise detector scale tolerance.
$fn = 96;

plate_size = [24.000000, 16.000000, 2.000000];
plate_origin = [-12.000000, -8.000000, 0.000000];
...
difference() {
  ...
  for (row = [0 : 1]) {
    for (col = [0 : 1]) {
      through_hole([-4.000000, -4.000000, -0.100000] + row * [0.000000, 8.000000, 0.000000] + col * [8.000000, 0.000000, 0.000000], 1.200000, 2.200000);  // grid_pattern_0
    }
  }
}
