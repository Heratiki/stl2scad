...
// fixture: plate_plain_rotated_x30
// fixture_type: plate
// description: Plain plate tilted 30° around the X axis. Guards against false axis-aligned plate detection and validates the rotated-plate detector.
