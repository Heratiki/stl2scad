...
// fixture: plate_thick
// fixture_type: plate
// description: Thick plate with thin_ratio of 0.20, validating detection in the 0.18–0.25 band unlocked by plate_thin_ratio_max=0.25.
$fn = 96;

plate_size = [30.000000, 20.000000, 6.000000];
