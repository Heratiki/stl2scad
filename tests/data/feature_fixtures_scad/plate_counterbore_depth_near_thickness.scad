...
// fixture: plate_counterbore_depth_near_thickness
// fixture_type: plate
// description: Counterbore depth is close to plate thickness without becoming a blind through-profile.
$fn = 96;

plate_size = [42.000000, 24.000000, 6.000000];
plate_origin = [-21.000000, -12.000000, 0.000000];
...
difference() {
  ...
  counterbore_hole([0.000000, 0.000000, 0.000000], 4.000000, 8.000000, 5.000000, 6.000000);  // counterbore_0
}
