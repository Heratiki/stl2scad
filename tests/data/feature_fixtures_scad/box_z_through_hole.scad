...
// fixture: box_z_through_hole
// fixture_type: box
// description: Centered box with one through-hole along the z axis.
$fn = 96;
...
difference() {
  ...
  through_hole_z([0.000000, 0.000000, 0.000000], 4.000000, 10.200000);  // hole_0
}
