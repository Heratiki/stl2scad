...
// fixture: box_small
// fixture_type: box
// description: Small box (8x6x4 mm) to verify scale invariance of the box_like_solid detector.
$fn = 96;

box_size = [8.000000, 6.000000, 4.000000];
box_origin = [-4.000000, -3.000000, -2.000000];
