...
// fixture: plate_large_hole_pair
// fixture_type: plate
// description: Large-diameter hole pair to exercise detector radius limits.
$fn = 96;

plate_size = [36.000000, 24.000000, 2.000000];
plate_origin = [-18.000000, -12.000000, 0.000000];
...
difference() {
  ...
  through_hole([-10.000000, 0.000000, -0.100000], 8.000000, 2.200000);  // hole_0
  through_hole([10.000000, 0.000000, -0.100000], 8.000000, 2.200000);  // hole_1
}
