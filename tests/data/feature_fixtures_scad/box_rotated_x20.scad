...
// fixture: box_rotated_x20
// fixture_type: box
// description: Plain box rotated 20 degrees around X. Complements existing Z-rotated cases with X-tilt baseline.
// transform: rotate=[20.000000, 0.000000, 0.000000], translate=[0.000000, 0.000000, 0.000000]
$fn = 96;

box_size = [18.000000, 12.000000, 8.000000];
box_origin = [-9.000000, -6.000000, -4.000000];
...
rotate([20.000000, 0.000000, 0.000000]) {
difference() {
