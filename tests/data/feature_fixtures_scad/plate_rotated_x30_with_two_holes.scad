...
// fixture: plate_rotated_x30_with_two_holes
// fixture_type: plate
// description: Plate rotated 30° around X with two through-holes in a linear pattern. Validates rotated-plate local-frame cutout detection for non-Z-axis rotation.
// transform: rotate=[30.000000, 0.000000, 0.000000], translate=[0.000000, 0.000000, 0.000000]
$fn = 96;
...
difference() {
  ...
  through_hole([-4.000000, 0.000000, -0.100000], 3.000000, 2.200000);  // hole_0
  through_hole([4.000000, 0.000000, -0.100000], 3.000000, 2.200000);  // hole_1
}
}
