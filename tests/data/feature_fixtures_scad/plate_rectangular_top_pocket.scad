...
// fixture: plate_rectangular_top_pocket
// fixture_type: plate
// description: Plate with one shallow rectangular top pocket to exercise blind-cuboid subtraction detection.
$fn = 96;

plate_size = [30.000000, 20.000000, 5.000000];
plate_origin = [-15.000000, -10.000000, 0.000000];
...
difference() {
  ...
  rectangular_top_pocket([0.000000, 4.000000, 0.000000], [8.000000, 6.000000], 2.000000, 5.000000);  // rectangular_pocket_0
}
