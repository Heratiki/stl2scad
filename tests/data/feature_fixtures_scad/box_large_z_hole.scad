...
// fixture: box_large_z_hole
// fixture_type: box
// description: Box with one large-diameter z-axis through-hole (d=8). Stresses hole-to-face-area ratio.
$fn = 96;
...
difference() {
  ...
  through_hole_z([0.000000, 0.000000, 0.000000], 8.000000, 12.200000);  // hole_0
}
