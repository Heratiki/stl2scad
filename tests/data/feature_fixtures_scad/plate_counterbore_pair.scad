...
// fixture: plate_counterbore_pair
// fixture_type: plate
// description: Two side-by-side counterbore holes in a thick plate.
$fn = 96;

plate_size = [50.000000, 24.000000, 8.000000];
plate_origin = [-25.000000, -12.000000, 0.000000];
...
difference() {
  ...
  counterbore_hole([-12.000000, 0.000000, 0.000000], 4.000000, 8.000000, 4.000000, 8.000000);  // counterbore_0
  counterbore_hole([12.000000, 0.000000, 0.000000], 4.000000, 8.000000, 4.000000, 8.000000);  // counterbore_1
}
